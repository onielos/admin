...
export class IndexProductoComponent implements OnInit {
  ...
  listar_etiquetas(){
    ...
    this._productoService.listar_etiquetas_admin(this.token).subscribe(
      response=>{
  ...
  eliminar_etiqueta(id:any){
    ...
    this._productoService.eliminar_etiqueta_admin(id,this.token).subscribe(
      response=>{
        iziToast.show({
            title: 'SUCCESS',
            titleColor: '#1DC74C',
  ...
  agregar_etiqueta(){
    if(this.nueva_etiqueta){
      ...
      this._productoService.agregar_etiqueta_admin(data,this.token).subscribe(
        response=>{
  ...
  cambiar_vs(id:any,vs:any){
    ...
    this._productoService.cambiar_vs_producto_admin(id,vs,this.token).subscribe(
      response=>{
        iziToast.show({
            title: 'SUCCESS',
            titleColor: '#1DC74C',
